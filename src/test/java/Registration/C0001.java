...
public class C0001 extends BaseTestSettings {
    ...
    public void positiveFemaleRegistration(String registrationForm, String userName, String email, String sexValue, String ageValue) {
        ...
        homePage.choseSearchParameters("girls");
        Reporter.log(" 2) Выбор параметр поиска 'Девушки' -> 'Переход в форму регистрации'");
        ...
        System.out.println("C0001 PASSED");
    }
}
